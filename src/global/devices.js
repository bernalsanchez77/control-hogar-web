export const devicesOriginal = {
    ...
    teleCuarto: {state: 'off', label: 'Tele Cuarto', id: 'teleCuarto', mute: 'off', channelSelected: 'none', input: {state: 'hdmi1', label: {hdmi1: 'Roku/Cable', hdmi2: 'Chromecast'}}},
    teleSala: {state: 'off', label: 'Tele Sala', id: 'teleSala', mute: 'off', channelSelected: 'none', input: {state: 'hdmi1', label: {hdmi1: 'Roku/Cable', hdmi2: 'Fire stick'}}},
    proyectorSala: {state: 'off', label: 'Proyector Sala', id: 'proyectorSala', mute: 'off', channelSelected: 'none', input: {state: 'hdmi1', label: {hdmi1: 'Roku/Cable', hdmi2: 'Playstation'}}},
