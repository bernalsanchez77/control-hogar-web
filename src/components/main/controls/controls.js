...
function Controls({devicesState, screenSelected, view, rokuApps, youtubeSearchVideos, youtubeLizVideos, cableChannels, changeControlParent, changeViewParent, changeVibrateParent, searchYoutubeParent}) {
